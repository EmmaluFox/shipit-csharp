...
namespace ShipIt.Repositories
{
    public class ConnectionHelper
    {
        public static string GetConnectionString()
        {
            ...
            if (dbname == null) return ConfigurationManager.ConnectionStrings["MyPostgres"].ConnectionString;
            ...
            return "Server=" + hostname + ";Port=" + port + ";Database=" + dbname + ";User ID=" + username +
                   ";Password=" + password + ";";
        }
    }
}